<!--OSCam;1102479673;1.20-unstable_svn;8864;-->
...
H2 {color:#AAAAAA;font-size:32px;line-height:32px;margin-top:0px; margin-bottom:0px}
H4 {color:#AAAAAA;font-size:12px;line-height:9px}
...
TABLE.status {border-spacing:1px;background-color:white;empty-cells:show}
...
TH {height:10px;padding:5px;background-color:#CCCCCC;color:black}
...
TH.notservices {}
TH.lbservices {}
TD {height:10px;padding:5px;background-color:#EEEEEE;color:black;text-align:left}
...
TD.subheadline {height:10px;border:0px;padding:5px;background-color:#CCCCCC;color:black}
...
DIV.log {border:1px dotted #AAAAAA;background-color:#FAFAFA;padding:10px;font-family:"Courier New", monospace;color:#666666;word-wrap:break-word; text-align:left}
DIV.sidlist {border:1px dotted #AAAAAA;background-color:#fffdf5;padding:2px;font-family:"Courier New", monospace;color:#666666;word-wrap:break-word; text-align:left}
DIV.message {font-size: 12px;font-weight:bold;}
...
TEXTAREA.editor {font-size:11px;width:98%;height:508px;border:1px dotted #AAAAAA;background-color: #FAFAFA;padding:8px 10px;font-family:"Courier New", monospace; color:black;word-wrap:break-word;text-align:left}
A.debugls:link {background-color:red}
A.debugls:visited {background-color:red}
A:link {color:#050840}
...
A:hover SPAN {display:block;position:absolute;top:2em;right:1em;padding:10px;color:#335500;font-weight:normal;background:#ffffdd;text-align: left;border: 1px solid #666}
IMG {border:0px solid}
IMG.icon {border:0px solid;width:22px;height:22px;background-color:#AA0000;border-radius:3px;-webkit-border-radius:3px}
IMG.userpicon {height:40px;width:80px}
