<!--OSCam;291581508;1.20-unstable_svn;9102;-->
##TPLHEADER##
##TPLMENU##
##TPLMESSAGE##
...
##TPLREADERCONFIGLBWEIGHT##
			...
			<TR><TD>##TPLHELPPREFIX##server#ratelimittime##TPLHELPSUFFIX##Ratelimittime in ms:</A></TD><TD><input name="ratelimittime" type="text" size="5" maxlength="5" value="##RATELIMITTIME##"></TD></TR>
