<!--OSCam;690217343;1.20-unstable_svn;9365;-->
/* 0. RESET
------------------------------------------------------------------------------------*/
...
#nav{height:20px;}
#mainmenu li, #nav li{display:inline;margin-left:2px;margin-right:2px;padding-top:5px;padding-bottom:3px;padding-left:3px;padding-right:3px;}
#nav li{padding-top:0px;padding-bottom:0px;}
ul#mainmenu.menu, ul#nav{padding-left:0px;margin:0;}
ul#mainmenu.menu{padding-top:10px;}
ul#nav{padding-top:0;}
li.menu a, li.configmenu a, li.menu_selected a, li.configmenu_selected a{text-decoration:none;}

/*size*/
#mainmenu li{font-size: 18px;font-weight: bold;}
#nav li{font-size: 14px;}

/*font*/
#mainmenu, #nav{font-family:arial, helvetica, sans-serif;}

/*color*/
#mainmenu, #nav{background-color:#FFFFFF;}
li.menu:hover,
li.menu_selected,
li.configmenu:hover,
li.configmenu_selected{background-color:#DDDDDD;}

/* 2. FOOTER
------------------------------------------------------------------------------------*/
div.footer{padding-bottom:5px;padding-top:5px;margin-bottom:0px;}
...
h4 {font-size:18px;line-height:9px;}
h4 {color:#aaa;}
...
TD.statuscol4,TD.statuscol4 A {text-align:center;text-decoration:none}
...
TD.statuscol9,TD.statuscol9 A {text-align:center;text-decoration:none}
TD.statuscol10 {text-align:center}
TD.statuscol11 {text-align:center}
TD.statuscol12 {text-align:center}
TD.statuscol13,TD.statuscol13 A {text-align:center;text-decoration:none}
...
TD.usercol1 {text-align:center;text-decoration:none}
...
input[type='checkbox'] {width:18px;height:18px;position: relative;top: 5px;}
...
IMG.icon {border:0px solid;width:22px;height:22px;background-color:#A00;border-radius:3px;-webkit-border-radius:3px; max-height:22px;}
IMG.statususericon, IMG.protoicon, IMG.usericon, IMG.readericon {min-height:22px;}
...
/* 15. OTHER CLASS
------------------------------------------------------------------------------------*/
DIV.info {max-width:1300px;margin:20px auto;border-top:1px solid #AAA}
TABLE.invisible TD:first-child {padding-left:0}
TABLE.statusmeminfo,TABLE.statususerinfo,TABLE.statuscacheexinfo {width:60%;margin:10px auto;white-space: no-wrap;}
TH.nameinfo {text-transform:uppercase;text-align:left;background-color:#999}
.hidden {display:none}
.visible {}
.span, span, span a {text-align:center;text-decoration:none}
tr.online td#lastchannel.usercol6{background-color:#646464;color:#FFFFFF;}
p#filename{color:#000000;font-weight:bold;font-size: 14px;}
