<!--OSCam;2647250868;1.20-unstable_svn;9365;-->
##TPLHEADER##
##TPLMENU##
##TPLCONFIGMENU##
##TPLMESSAGE##
...
##TPLUNLOCKPARENTAL##
			<TR><TD>##TPLHELPPREFIX##conf#block_same_ip##TPLHELPSUFFIX##Simple block same:</A></TD>
				<TD>
					...
					<select name="block_same_name"><option VALUE="0">Name - No</option><option VALUE="1" ##BLOCKSAMENAMECHECKED##>Name - Yes</option></select>
				</TD>
			</TR>
			<TR><TD>##TPLHELPPREFIX##conf#dropdups##TPLHELPSUFFIX##Drop duplicate users:</A></TD><TD><input name="dropdups" value="0" type="hidden"><input name="dropdups" value="1" type="checkbox" ##DROPDUPSCHECKED##></TD></TR>
