<!--OSCam;17548714;1.20-unstable_svn;9365;-->
##TPLHEADER##
##TPLMENU##
##TPLCONFIGMENU##
##TPLMESSAGE##
...
##CSSOPTIONS##
			...
			<TR><TD>##TPLHELPPREFIX##conf#httpshowpicons##TPLHELPSUFFIX##Http Show Picons:</A></TD><TD><SPAN><input name="httpshowpicons" value="0" type="hidden"><input name="httpshowpicons" type="checkbox" value="1" ##SHOWPICONSCHECKED##>Height: <input name="httppiconsize" type="text" size="5" maxlength="5" value="##HTTPPICONSIZE##"> px</SPAN></TD></TR>
