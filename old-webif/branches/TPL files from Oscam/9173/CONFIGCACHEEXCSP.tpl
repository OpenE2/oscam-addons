<!--OSCam;4050278529;1.20-unstable_svn;9173;CS_CACHEEX-->
			...
			<TR><TD>##TPLHELPPREFIX##conf#csp_allow_reforward##TPLHELPSUFFIX##Reforward cacheex:</A></TD><TD><TABLE class="invisible"><TR><TD><input name="csp_allow_reforward" value="0" type="hidden"><input name="csp_allow_reforward" value="1" type="checkbox" ##ARFCHECKED##>allow reforward</TD></TR></TABLE></TD></TR>
