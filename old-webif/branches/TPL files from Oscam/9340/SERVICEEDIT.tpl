<!--OSCam;2620287711;1.20-unstable_svn;9340;-->
##TPLHEADER##
##TPLMENU##
##TPLMESSAGE##
	<form action="services_edit.html" method="get">
		...
		<TABLE CLASS="stats upspace">
			...
			<TR><TD>##TPLHELPPREFIX##services#srvid##TPLHELPSUFFIX##Srvid: </A></TD><TD><textarea name="srvid" cols="70" rows="10">##SRVIDS##</textarea></TD></TR>
