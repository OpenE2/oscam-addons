<!--OSCam;2353217712;1.20-unstable_svn;9340;WITH_DEBUG-->
<DIV CLASS="debugmenu">
	...
	<SPAN CLASS="debugl"><A CLASS="##DCLASS2048##" HREF="##NEXTPAGE##?debug=##DEBUGVAL2048####CUSTOMPARAM##" TITLE="CSP logging">&nbsp;2048&nbsp;</A></SPAN>
	<SPAN CLASS="debugl"><A CLASS="##DCLASS4096##" HREF="##NEXTPAGE##?debug=##DEBUGVAL4096####CUSTOMPARAM##" TITLE="CWC logging">&nbsp;4096&nbsp;</A></SPAN>
