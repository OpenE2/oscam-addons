<!--OSCam;178551462;1.20-unstable_svn;9340;-->
/* 1. RESET 
------------------------------------------------------------------------------------*/
HTML,DIV,TABLE,TBODY,TFOOT,THEAD,TR,TH,TD {margin:0;padding:0;border:0}

#mainmenu li,#nav li{display:inline;list-style-type:none;margin-top:0px;}
#mainmenu li{font-size: 16px;font-weight: bold;}
div#subnav ul#nav{margin-bottom: 20px;margin-top: 0;padding-top: 5px;}
div#main ul#mainmenu.menu{margin-bottom: 0;margin-top: 0;padding-left: 0;padding-top: 5px;}
ul#mainmenu.menu li.menu:hover,
ul#mainmenu.menu li.menu_selected,
ul#nav.configmenu li.configmenu:hover,
ul#nav.configmenu li.configmenu_selected{background-color:#ddeeee;}
...
TABLE.footer tbody tr td.centered{background-color:#EEEEEE}
...
IMG.userpicon,IMG.statususericon {max-height:22px;}
...
/* 15. OTHER CLASS
------------------------------------------------------------------------------------*/
DIV.footer {clear:both;border-top:1px solid #AAA;margin:20px auto;padding-top:10px;background-color:#EEEEEE}
DIV.footerwidth {max-width:1300px}
...
ul#mainmenu.menu li.menu a,
ul#mainmenu.menu li.menu_selected a{text-decoration:none;}
