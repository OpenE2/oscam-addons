<!--OSCam;3200539694;1.20-unstable_svn;8789;-->
##TPLHEADER##
##TPLMENU##
##TPLMESSAGE##
      ...
      <TR><TD COLSPAN="2">
        <TABLE CLASS="invisiblelb">
            ...
            <TH CLASS="withservices">##TPLHELPPREFIX##server#services##TPLHELPSUFFIX##With_Services:</A></TH>
				    ...
				    <TH CLASS="lbservices">##TPLHELPPREFIX##server#lb_whitelist_servicesservices##TPLHELPSUFFIX##LB_Whitelist_Services:</A></TH>
          </TR>
				  <TR>
          ##SIDS##
				  </TR>
