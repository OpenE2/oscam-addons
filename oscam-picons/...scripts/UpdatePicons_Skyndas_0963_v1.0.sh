...
TrunkUrl="http://www.streamboard.tv/svn/oscam-addons/oscam-picons/skyndas/0963"
TrunkFile='Skyndas_0963.zip'
#
# 3.
# Set manually INFO file (list of files that contain Template) without trailing "/"
InfoFile='info_0963.txt'
#
# 4.
...
if [ -s "$InfoFile" ]; then
	# Print Info about PREVIOUS version of picons for CAID 0963
	InfoRevision=$(parseInfoTxt "Revision")
	InfoAuthors=$(parseInfoTxt "Authors")
	InfoDate=$(parseInfoTxt "Date")

	# Print to display about the PREVIOUS version of picons for CAID 0963
	echo ""
	echo "Current installed version of picons for CAID-0963:"
	echo "$hr"
	...
	# Remove the previous files
		# Print to display
		echo ""
		echo "Deleting old (unused) files of picons for CAID-0963"
		echo "$hr"
...
if [ -s $InfoFile ]; then
	# Print to display about the NEW installed version of picons for CAID 0963
  InfoRevision=$(parseInfoTxt "Revision:")
  InfoAuthors=$(parseInfoTxt "Authors:")
  InfoDate=$(parseInfoTxt "Date:")
