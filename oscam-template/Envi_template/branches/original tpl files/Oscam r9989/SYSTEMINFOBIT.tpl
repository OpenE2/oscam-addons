<!--OSCam;1554736573;1.20-unstable_svn;9989;-->
<TBODY CLASS="statusmeminfo ##DISPLAYSYSINFO##">
	...
	<TR>
		...
		<TD COLSPAN="3" CLASS="centered"><B>Free:</B>&nbsp;<span id="mem_cur_free">##MEM_CUR_FREE##</span></TD>
		<TD COLSPAN="3" CLASS="centered"><B>Used:</B>&nbsp;<span id="mem_cur_used">##MEM_CUR_USED##</span></TD>
		<TD COLSPAN="3" CLASS="centered"><B>Buffer:</B>&nbsp;<span id="mem_cur_buff">##MEM_CUR_BUFF##</span></TD>
	</TR>
	<TR>
		<TH>OSCam</TH>
...
<TBODY CLASS="statuscpuinfo ##DISPLAYLOADINFO##">
	...
	<TR>
		<TH>SYSTEM</TH>
		<TD COLSPAN="4" CLASS="centered"><B>last 1 minute:</B>&nbsp;<span id="cpu_load_0">##CPU_LOAD_0##</span></TD>
		<TD COLSPAN="4" CLASS="centered"><B>last 5 minutes:</B>&nbsp;<span id="cpu_load_1">##CPU_LOAD_1##</span></TD>
		<TD COLSPAN="4" CLASS="centered"><B>last 15 minutes:</B>&nbsp;<span id="cpu_load_2">##CPU_LOAD_2##</span></TD>
	</TR>
	<TR><TH COLSPAN="13" CLASS="nameinfo">CPU Usage since last refresh (<span id="oscam_refresh">##OSCAM_REFRESH##</span>)</TH></TR>
	<TR>
		<TH>OSCam</TH>
