<!--OSCam;3068564626;1.20-unstable_svn;9681;-->
##TPLHEADER##
##TPLMENU##
##TPLCONFIGMENU##
##TPLMESSAGE##
	<form action="config.html" method="get">
		...
		<TABLE CLASS="config">
			...
			<TR><TD>##TPLHELPPREFIX##conf#httposcamlabel##TPLHELPSUFFIX##OSCam Label:</A></TD><TD><input name="httposcamlabel" type="text" size="63" maxlength="64" value="##HTTPOSCAMLABEL##"></TD></TR>
			<TR><TD>##TPLHELPPREFIX##conf#httprefresh##TPLHELPSUFFIX##Refresh:</A></TD><TD>Http: <input name="httprefresh" type="text" size="5" maxlength="5" value="##HTTPREFRESH##"> s &nbsp;&nbsp;Poll (initialrefresh): <input name="httppollrefresh" type="text" size="5" maxlength="5" value="##HTTPPOLLREFRESH##"> s</TD></TR>
			...
			<TR><TH></TH><TH>Css style settings</TH></TR>
...
##CSSOPTIONS##
			...
			<TR><TH></TH><TH>Script settings</TH></TR>
...
##CONFIGWEBIFJQUERY##
			<TR><TH></TH><TH>Picons settings</TH></TR>
			<TR><TD>##TPLHELPPREFIX##conf#httpshowpicons##TPLHELPSUFFIX##Http Show Picons:</A></TD>
				<TD>
					<TABLE CLASS="invisible">
						<TR>
							<TD><input name="httpshowpicons" value="0" type="hidden"><input name="httpshowpicons" type="checkbox" value="1" ##SHOWPICONSCHECKED##></TD>
							<TD>Height: <input name="httppiconsize" type="text" size="5" maxlength="5" value="##HTTPPICONSIZE##"> px</TD>
						</TR>
					</TABLE>
				</TD>
			</TR>
			<TR><TH></TH><TH>Show/Hide in Status</TH></TR>
			<TR><TD>##TPLHELPPREFIX##conf#httphideidleclients##TPLHELPSUFFIX##Http Hide Idle Clients:</A></TD>
				<TD>
					<TABLE CLASS="invisible">
						<TR>
							<TD><input name="httphideidleclients" value="0" type="hidden"><input name="httphideidleclients" type="checkbox" value="1" ##CHECKED##></TD>
							<TD>##TPLHELPPREFIX##conf#hideclient_to##TPLHELPSUFFIX##Hide client to:</A>&nbsp;&nbsp;<input name="hideclient_to" type="text" size="5" maxlength="5" value="##HIDECLIENTTO##"> s</TD>
						</TR>
					</TABLE>
				</TD>
			</TR>
			...
			<TR><TD>##TPLHELPPREFIX##conf#httpshowstats##TPLHELPSUFFIX##Show in STATUS:</A></TD>
				<TD>
					<TABLE CLASS="invisible">
						<TR>
							<TD><input name="http_status_log" type="hidden" value="0"><input name="http_status_log" type="checkbox" value="1" ##SHOWLOGCHECKED##> Log</TD>
							<TD><input name="httpshowmeminfo" type="hidden" value="0"><input name="httpshowmeminfo" type="checkbox" value="1" ##SHOWMEMINFOCHECKED##> Memory info</TD>
							<TD><input name="httpshowloadinfo" type="hidden" value="0"><input name="httpshowloadinfo" type="checkbox" value="1" ##SHOWLOADINFOCHECKED##> Load info</TD>
							...
							<TD><input name="httpshowecminfo" type="hidden" value="0"><input name="httpshowecminfo" type="checkbox" value="1" ##SHOWECMINFOCHECKED##> ECM info</TD>
##TPLSHOWCACHEEXINFO##
						</TR>
					</TABLE>
				</TD>
			</TR>
			<TR><TH></TH><TH>Template settings</TH></TR>
