<!--OSCam;1380223217;1.20-unstable_svn;9535;WITH_CARDREADER-->
			<TR><TD>##TPLHELPPREFIX##conf#waitforcards##TPLHELPSUFFIX##Wait for cards:</A></TD>
				<TD>
					<input name="waitforcards" type="hidden" value="0"><input name="waitforcards" type="checkbox" value="1" ##WAITFORCARDSCHECKED##>&nbsp;enable clientlogins while init
				</TD>
			</TR>
