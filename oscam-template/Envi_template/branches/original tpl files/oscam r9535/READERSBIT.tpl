<!--OSCam;2648984757;1.20-unstable_svn;9535;-->
			<TR CLASS ="##READERCLASS##">
				...
				<TD><SPAN TITLE="##DESCRIPTION##">##READERNAME##</SPAN></TD>
				<TD ID="readertyp">##CTYP##</TD>
				<TD CLASS="centered"><DIV CLASS="groups" TITLE="##GROUPS##">##GROUPS##</DIV></TD>
...
##TPLREADERLBBIT##
				...
				<TD CLASS="centered"><A HREF="readers.html?label=##READERNAMEENC##&amp;action=delete" TITLE="Delete this Reader"><IMG CLASS="icon" SRC="image?i=ICDEL" ALT="Delete Reader" onclick="return confirm('Delete ##READERNAMEENC## ?')"></A></TD>
			</TR>