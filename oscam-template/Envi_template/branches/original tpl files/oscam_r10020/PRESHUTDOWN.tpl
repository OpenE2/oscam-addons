<!--OSCam;4073151508;1.20-unstable_svn;10020;-->
##TPLHEADER##
##TPLMENU##
		<DIV class="warning">
		...
		<form action="shutdown.html" method="get">
			...
			<input type="submit" name="action" value="Restart" onclick="return confirm('Restart OSCam ?')" title="Restart OSCam" ##BTNDISABLED##>
		</form>
##TPLFOOTER##
