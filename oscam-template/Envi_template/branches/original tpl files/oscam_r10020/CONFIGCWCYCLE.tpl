<!--OSCam;227607941;1.20-unstable_svn;10020;CW_CYCLE_CHECK-->
			...
			<TR><TD><A>Max Cycle List Entrys:</A></TD><TD><input name="cwcycle_maxlist" class="withunit short" type="text" maxlength="6" value="##MAXCYCLELIST##"> max Count of Cyclelist Entrys *Default 500 ** max 4000 Entrys*</TD></TR>
