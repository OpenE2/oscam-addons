<!--OSCam;155739965;1.20-unstable_svn;9705;CS_CACHEEX-->
			<TR><TH COLSPAN="2">CacheEX</TH></TR>
				...
				<TR><TD><A>Cache-EX 2 ECM filter:</A></TD><TD><input name="cacheex_ecm_filter" type="text" size="63" maxlength="320" value="##CACHEEX_ECM_FILTER##"></TD></TR>
