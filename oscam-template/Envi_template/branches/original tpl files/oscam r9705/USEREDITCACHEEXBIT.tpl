<!--OSCam;3630456497;1.20-unstable_svn;9705;CS_CACHEEX-->
				...
				<TR><TD><A>Cache-EX Maxhop:</A></TD><TD><input name="cacheex_maxhop" type="text" size="4" maxlength="4" value="##CACHEEX_MAXHOP##"></TD></TR>
				<TR><TD><A>No Wait Time:</A><TD><input name="no_wait_time" value="0" type="hidden"><input name="no_wait_time" value="1" type="checkbox" ##NWTCHECKED##><label>no wait time</label></TD></TR>
				<TR><TD><A>Cache-EX 3 ECM filter:</A></TD><TD><input name="cacheex_ecm_filter" type="text" size="63" maxlength="320" value="##CACHEEX_ECM_FILTER##"></TD></TR>
				<TR><TD><A>Cache-EX 3 filter adv.:</A></TD>
					<TD>
