<!--OSCam;166956342;1.20-unstable_svn;9705;CW_CYCLE_CHECK-->
			...
			<TR><TD><A>Cycle Check Caids:</A></TD><TD><input name="cwcycle_check_caid" type="text" size="63" maxlength="160" value="##CWCYCLECHECKCAID##"></TD></TR>
			<TR><TD><A>Max Cycle List Entrys:</A></TD><TD><input name="cwcycle_maxlist" class="withunit" type="text" size="5" maxlength="6" value="##MAXCYCLELIST##"> max Count of Cyclelist Entrys *Default 500 ** max 4000 Entrys*</TD></TR>
			<TR><TD><A>Keep Cycletime:</A></TD><TD><input name="cwcycle_keeptime" class="withunit" type="text" size="5" maxlength="6" value="##KEEPCYCLETIME##"> min Keep Learned Cycletime in Memory *Default 15 ** max 240 Min*</TD></TR>
			<TR><TD><A>On Bad Cycle:</A></TD><TD><SELECT name="cwcycle_onbad"><option value="0">0 - only Log Bad CW</option><option value="1" ##ONBADCYCLE1##>1 - Drop BAD CW / IGN Swapped CW</option><option value="2" ##ONBADCYCLE2##>2 - Drop BAD CW / Drop Swapped CW</option></select></TD></TR>
