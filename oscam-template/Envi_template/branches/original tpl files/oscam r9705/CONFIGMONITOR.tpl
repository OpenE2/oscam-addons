<!--OSCam;2649638156;1.20-unstable_svn;9705;MODULE_MONITOR-->
		<input name="part" type="hidden" value="monitor">
		<TABLE CLASS="config">
			<TR><TH COLSPAN="2">Edit Monitor Config</TH></TR>
			<TR><TD><A>Port:</A></TD><TD><input name="port" type="text" size="5" maxlength="5" value="##MONPORT##"></TD></TR>
			<TR><TD><A data-p="serverip_2">Serverip:</A></TD><TD><input name="serverip" type="text" size="15" maxlength="15" value="##SERVERIP##"></TD></TR>
			<TR><TD><A>No crypt:</A></TD><TD><input name="nocrypt" type="text" size="63" maxlength="200" value="##NOCRYPT##"></TD></TR>
			<TR><TD><A>Au low:</A></TD><TD><input name="aulow" class="withunit" type="text" size="5" maxlength="5" value="##AULOW##"> min</TD></TR>
			<TR><TD><A>Hide client to:</A></TD><TD><input name="hideclient_to" class="withunit" type="text" size="5" maxlength="5" value="##HIDECLIENTTO##"> s</TD></TR>
			<TR>
				<TD><A>Monlevel:</A></TD>
