<!--OSCam;3812672383;1.20-unstable_svn;9705;HAVE_DVBAPI-->
	...
	<TABLE CLASS="config">
		...
		<TR><TD><A data-p="user_2">User:</A></TD><TD><input name="user" type="text" size="63" maxlength="63" value="##USERNAME##"></TD></TR>
		...
		<TR><TD><A>Listen port:</A></TD><TD><input name="listen_port" type="text" size="5" maxlength="5" value="##LISTENPORT##"> TCP port to listen instead of camd.socket</TD></TR>
		<TR><TD><A>Delayer:</A></TD><TD><input name="delayer" class="withunit" type="text" size="5" maxlength="4" value="##DELAYER##"> ms</TD></TR>
