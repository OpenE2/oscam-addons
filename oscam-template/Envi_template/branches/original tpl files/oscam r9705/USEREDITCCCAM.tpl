<!--OSCam;1340343048;1.20-unstable_svn;9705;MODULE_CCCAM-->
				<TR><TH COLSPAN="2">User specific settings for CCcam</TH></TR>
				<TR><TD><A>CCC Maxhops:</A></TD><TD><input name="cccmaxhops" type="text" size="3" maxlength="2" value="##CCCMAXHOPS##"></TD></TR>
				<TR><TD><A>CCC Reshare:</A></TD><TD><input name="cccreshare" type="text" size="3" maxlength="2" value="##CCCRESHARE##">
