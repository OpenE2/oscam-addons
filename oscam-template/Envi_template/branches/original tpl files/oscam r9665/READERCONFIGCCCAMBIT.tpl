<!--OSCam;1816050632;1.20-unstable_svn;9665;MODULE_CCCAM-->
			...
			<TR><TD>##TPLHELPPREFIX##server#ccckeepalive##TPLHELPSUFFIX##Keep alive:</A><input name="ccckeepalive" type="hidden" value="0"></TD><TD><input name="ccckeepalive" type="checkbox" value="1" ##KEEPALIVECHECKED##></TD></TR>
