<!--OSCam;1897227228;1.20-unstable_svn;9665;MODULE_CCCSHARE-->
##TPLHEADER##
##TPLMENU##
##TPLCONFIGMENU##
##TPLMESSAGE##
	<form action="config.html" method="get">
		...
		<TABLE CLASS="config">
			...
			<TR><TD>##TPLHELPPREFIX##conf#forward_origin_card##TPLHELPSUFFIX##Forward origin card:</A></TD>
				<TD>
					<input name="forward_origin_card" value="0" type="hidden"><input name="forward_origin_card" value="1" type="checkbox" ##FORWARDORIGINCARD##>
				</TD>
			</TR>
			<TR><TD>##TPLHELPPREFIX##conf#stealth##TPLHELPSUFFIX##Stealth mode:</A></TD>
				<TD>
					<input name="stealth" value="0" type="hidden"><input name="stealth" value="1" type="checkbox" ##STEALTH##>
				</TD>
			</TR>
			...
			<TR><TD>##TPLHELPPREFIX##conf#keepconnected##TPLHELPSUFFIX##Keep clients connected:</A></TD>
				<TD>
					<input name="keepconnected" value="0" type="hidden"><input name="keepconnected" value="1" type="checkbox" ##KEEPCONNECTED##>
				</TD>
			</TR>
			...
			<TR><TD COLSPAN="2"><input type="submit" value="Save" ##BTNDISABLED##></TD></TR>
		</TABLE>
	</form>
	<TABLE CLASS="config">
