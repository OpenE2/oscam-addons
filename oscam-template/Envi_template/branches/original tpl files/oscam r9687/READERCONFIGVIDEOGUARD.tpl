<!--OSCam;1554613618;1.20-unstable_svn;9687;READER_VIDEOGUARD-->
				...
				<TR><TD>##TPLHELPPREFIX##server#fix9993##TPLHELPSUFFIX##Fix 9993 for CAID 0919:</A><input name="fix9993" type="hidden" value="0"></TD><TD><input name="fix9993" type="checkbox" value="1" ##FIX9993CHECKED##><label></label></TD></TR>
				...
				<TR><TD>##TPLHELPPREFIX##server#ins2e06##TPLHELPSUFFIX##ins2E06 payload (4 bytes):</A></TD><TD><input name="ins2e06" type="text" size="15" maxlength="8" value="##INS2E06##"></TD></TR>