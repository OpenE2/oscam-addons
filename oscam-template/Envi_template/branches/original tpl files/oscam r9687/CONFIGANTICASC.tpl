<!--OSCam;3082256995;1.20-unstable_svn;9687;CS_ANTICASC-->
##TPLHEADER##
##TPLMENU##
##TPLCONFIGMENU##
##TPLMESSAGE##
	<form action="config.html" method="get">
		...
		<TABLE CLASS="config">
			...
			<TR><TD>##TPLHELPPREFIX##conf#enabled_2##TPLHELPSUFFIX##Enabled:</A></TD><TD><input name="enabled" type="checkbox" value="1" ##CHECKED##><label></label></TD></TR>
