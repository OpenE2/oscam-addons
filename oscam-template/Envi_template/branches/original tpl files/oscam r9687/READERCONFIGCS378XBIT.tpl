<!--OSCam;3127555105;1.20-unstable_svn;9687;MODULE_CAMD35_TCP-->
			...
			<TR><TD>##TPLHELPPREFIX##server#keepalive##TPLHELPSUFFIX##Keepalive:</A><input name="keepalive" type="hidden" value="0"></TD><TD><input name="keepalive" type="checkbox" value="1" ##RDRKEEPALIVE##><label></label></TD></TR>
