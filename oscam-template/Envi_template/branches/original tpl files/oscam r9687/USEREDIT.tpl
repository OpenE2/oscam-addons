<!--OSCam;1964450528;1.20-unstable_svn;9687;-->
##TPLHEADER##
##TPLMENU##
##TPLMESSAGE##
<DIV ID="subnav"><UL ID="nav"><LI CLASS="text_entitle">Edit User ##USERNAME##</LI></UL></DIV>
	<form action="user_edit.html" method="get">
		...
		<TABLE CLASS="configuser">
			...
			<TR><TD>##TPLHELPPREFIX##user#disabled##TPLHELPSUFFIX##Disabled:</A></TD><TD><input name="disabled" type="hidden" value="0"><input name="disabled" type="checkbox" value="1" ##DISABLEDCHECKED##><label></label></TD></TR>
...
##TPLUSEREDITANTICASC##
##TPLUSEREDITCCCAM##
			<TR><TD>##TPLHELPPREFIX##user#keepalive##TPLHELPSUFFIX##Keepalive:</A></TD><TD><input name="keepalive" type="hidden" value="0"><input name="keepalive" type="checkbox" value="1" ##KEEPALIVE##><label></label></TD></TR>
