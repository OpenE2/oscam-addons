<!--OSCam;603157034;1.20-unstable_svn;9687;-->
##TPLHEADER##
##TPLMENU##
##TPLMESSAGE##
<DIV ID="subnav"><UL ID="nav"><LI CLASS="text_entitle">Edit Reader ##READERNAME##</LI></UL></DIV>
	<form action="readerconfig.html?action=execute" method="get">
		...
		<TABLE CLASS="configreader">
			...
			<TR><TD>##TPLHELPPREFIX##server#enable##TPLHELPSUFFIX##Enable:</A></TD><TD><input name="enable" type="hidden" value="0"><input name="enable" type="checkbox" value="1" ##ENABLED##><label></label></TD></TR>
			...
			<TR><TD>##TPLHELPPREFIX##server#fallback##TPLHELPSUFFIX##Fallback:</A></TD><TD><input name="fallback" type="hidden" value="0"><input name="fallback" type="checkbox" value="1" ##FALLBACKCHECKED##><label></label></TD></TR>
			<TR><TD>##TPLHELPPREFIX##server#fallback_percaid##TPLHELPSUFFIX##Fallback per caid:</A></TD><TD><textarea name="fallback_percaid" cols="58" rows="3" class="bt">##FALLBACK_PERCAID##</textarea></TD></TR>
##TPLREADERCONFIGLBWEIGHT##
			...
			<TR><TD>##TPLHELPPREFIX##server#audisabled##TPLHELPSUFFIX##AU disabled:</A></TD><TD><input name="audisabled" type="hidden" value="0"><input name="audisabled" type="checkbox" value="1" ##AUDISABLED##><label></label></TD></TR>
			...
			<TR><TD>##TPLHELPPREFIX##server#ecmunique##TPLHELPSUFFIX##ECM Unique:</A><input name="ecmunique" type="hidden" value="0"></TD><TD><input name="ecmunique" type="checkbox" value="1" ##ECMUNIQUECHECKED##><label></label></TD></TR>
			<TR><TD>##TPLHELPPREFIX##server#ratelimittime##TPLHELPSUFFIX##Ratelimittime:</A></TD><TD><input name="ratelimittime" type="text" size="5" maxlength="5" value="##RATELIMITTIME##"> ms</TD></TR>
			<TR><TD>##TPLHELPPREFIX##server#srvidholdtime##TPLHELPSUFFIX##Additional ms to hold SRVID in slot:</A></TD><TD><input name="srvidholdtime" type="text" size="5" maxlength="5" value="##SRVIDHOLDTIME##"></TD></TR>
			...
			<TR><TD>##TPLHELPPREFIX##server#dropbadcws##TPLHELPSUFFIX##Drop CWs with wrong checksum:</A><input name="dropbadcws" type="hidden" value="0"></TD><TD><input name="dropbadcws" type="checkbox" value="1" ##DROPBADCWSCHECKED##><label></label></TD></TR>
			<TR><TD>##TPLHELPPREFIX##server#disablecrccws##TPLHELPSUFFIX##Skip CWs checksum test:</A><input name="disablecrccws" type="hidden" value="0"></TD><TD><input name="disablecrccws" type="checkbox" value="1" ##DISABLECRCCWSCHECKED##><label></label></TD></TR>
			...
			<TR><TH COLSPAN="2">Reader services settings</TH></TR>
			<TR><TD COLSPAN="2">
...
##TPLREADEREDITCACHEEXBIT##
			<TR><TD COLSPAN="2" ALIGN="right"><input type="submit" name="action" value="Save" title="Save settings and reload Reader" ##BTNDISABLED##></TD></TR>
		</TABLE>
	</form>
##TPLFOOTER##
