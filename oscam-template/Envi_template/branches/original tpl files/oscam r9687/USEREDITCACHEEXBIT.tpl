<!--OSCam;3520893698;1.20-unstable_svn;9687;CS_CACHEEX-->
				...
				<TR><TD>##TPLHELPPREFIX##user#no_wait_time##TPLHELPSUFFIX##No Wait Time:</A><TD><input name="no_wait_time" value="0" type="hidden"><input name="no_wait_time" value="1" type="checkbox" ##NWTCHECKED##><label>no wait time</label></TD></TR>
