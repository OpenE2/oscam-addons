<!--OSCam;2615666226;1.20-unstable_svn;9687;CS_CACHEEX-->
			...
			<TR><TD>##TPLHELPPREFIX##conf#cacheexenablestats_2##TPLHELPSUFFIX##Write statistic:</A></TD><TD><input name="cacheexenablestats" value="0" type="hidden"><input name="cacheexenablestats" value="1" type="/" ##CACHEEXSTATSSELECTED##><label></label></TD></TR>
			<TR><TD>##TPLHELPPREFIX##conf#wait_until_ctimeout##TPLHELPSUFFIX##Wait until ctimeout:</A></TD><TD><input name="wait_until_ctimeout" value="0" type="hidden"><input name="wait_until_ctimeout" value="1" type="checkbox" ##WTTCHECKED##><label></label></TD></TR>
			...
			<TR><TD>##TPLHELPPREFIX##conf#csp_allow_request##TPLHELPSUFFIX##ECM filter adv.:</A></TD><TD><input name="csp_allow_request" value="0" type="hidden"><input name="csp_allow_request" value="1" type="checkbox" ##ARCHECKED##><label>allow request</label></TD></TR>
			<TR><TD>##TPLHELPPREFIX##conf#csp_allow_reforward##TPLHELPSUFFIX##Reforward cacheex:</A></TD><TD><input name="csp_allow_reforward" value="0" type="hidden"><input name="csp_allow_reforward" value="1" type="checkbox" ##ARFCHECKED##><label>allow reforward</label></TD></TR>
