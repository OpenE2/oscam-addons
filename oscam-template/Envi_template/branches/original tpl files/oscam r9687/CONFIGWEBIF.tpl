<!--OSCam;438101856;1.20-unstable_svn;9687;-->
##TPLHEADER##
##TPLMENU##
##TPLCONFIGMENU##
##TPLMESSAGE##
	<form action="config.html" method="get">
		...
		<TABLE CLASS="config">
			...
			<TR><TD>##TPLHELPPREFIX##conf#httprefresh##TPLHELPSUFFIX##Refresh:</A></TD><TD>Http: <input name="httprefresh" type="text" size="5" maxlength="5" value="##HTTPREFRESH##"> s &nbsp;&nbsp;Poll (initial refresh): <input name="httppollrefresh" type="text" size="5" maxlength="5" value="##HTTPPOLLREFRESH##"> s</TD></TR>
			...
			<TR><TD>##TPLHELPPREFIX##conf#httpsavefullcfg##TPLHELPSUFFIX##Http save full config:</A></TD><TD><input name="httpsavefullcfg" value="0" type="hidden"><input name="httpsavefullcfg" type="checkbox" value="1" ##HTTPSAVEFULLSELECT##><label></label></TD></TR>
			<TR><TH></TH><TH>Css style settings</TH></TR>
			<TR><TD>##TPLHELPPREFIX##conf#http_prepend_embedded_css##TPLHELPSUFFIX##Http prepend embedded css:</A></TD><TD><input name="http_prepend_embedded_css" value="0" type="hidden"><input name="http_prepend_embedded_css" type="checkbox" value="1" ##HTTPPREPENDEMBEDDEDCSS##><label></label></TD></TR>
