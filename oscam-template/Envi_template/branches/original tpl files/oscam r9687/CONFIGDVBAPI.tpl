<!--OSCam;1721458426;1.20-unstable_svn;9687;HAVE_DVBAPI-->
##TPLHEADER##
##TPLMENU##
##TPLCONFIGMENU##
##TPLMESSAGE##
<form action="config.html" method="get">
	...
	<TABLE CLASS="config">
		...
		<TR><TD>##TPLHELPPREFIX##conf#enabled##TPLHELPSUFFIX##Enabled:</A></TD><TD><input name="enabled" type="checkbox" value="1" ##ENABLEDCHECKED##><label></label>
		<TR><TD>##TPLHELPPREFIX##conf#au##TPLHELPSUFFIX##AU:</A></TD><TD><input name="au" type="checkbox" value="1" ##AUCHECKED##><label></label>
