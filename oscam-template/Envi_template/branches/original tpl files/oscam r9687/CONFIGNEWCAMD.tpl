<!--OSCam;2845893980;1.20-unstable_svn;9687;MODULE_NEWCAMD-->
##TPLHEADER##
##TPLMENU##
##TPLCONFIGMENU##
##TPLMESSAGE##
	<form action="config.html" method="get">
		...
		<TABLE CLASS="config">
			...
			<TR><TD>##TPLHELPPREFIX##conf#keepalive##TPLHELPSUFFIX##Keepalive:</A></TD><TD><input name="keepalive" type="checkbox" value="1" ##KEEPALIVE##><label></label></TD></TR>
			<TR><TD>##TPLHELPPREFIX##conf#mgclient##TPLHELPSUFFIX##Mgclient:</A></TD><TD><input name="mgclient" type="checkbox" value="1" ##MGCLIENTCHK##><label></label></TD></TR>
