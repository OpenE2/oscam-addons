<!--OSCam;2684068055;1.20-unstable_svn;10358;WEBIF_LIVELOG-->
##TPLHEADERSHORT##
...
##LOG_DEBUGMENU##
			<UL ID="regexdatainput">
				<LI style="display:none;"><span class="colorPicker_def_color"></span><span class="colorPicker_def_fcolor"></span></LI>
				<LI class="regex">Search1: <input type="text" name="regex1" class="regexinput" ID="regex1" value=""> Found only: <input type="checkbox" id="whitelisted1"><label></label> Hide: <input type="checkbox" id="hidden1"><label></label> Back Color: <input size="7" maxlength="7" type="text" name="color1" class="colorinput" ID="color1" value=""> Color: <input size="7" maxlength="7" type="text" name="fcolor1" class="colorinput" ID="fcolor1" value=""></LI>
				<LI class="regex">Search2: <input type="text" name="regex2" class="regexinput" ID="regex2" value=""> Found only: <input type="checkbox" id="whitelisted2"><label></label> Hide: <input type="checkbox" id="hidden2"><label></label> Back Color: <input size="7" maxlength="7" type="text" name="color2" class="colorinput" ID="color2" value=""> Color: <input size="7" maxlength="7" type="text" name="fcolor2" class="colorinput" ID="fcolor2" value=""></LI>
				<LI class="regex">Search3: <input type="text" name="regex3" class="regexinput" ID="regex3" value=""> Found only: <input type="checkbox" id="whitelisted3"><label></label> Hide: <input type="checkbox" id="hidden3"><label></label> Back Color: <input size="7" maxlength="7" type="text" name="color3" class="colorinput" ID="color3" value=""> Color: <input size="7" maxlength="7" type="text" name="fcolor3" class="colorinput" ID="fcolor3" value=""></LI>
				<LI class="regex">Search4: <input type="text" name="regex4" class="regexinput" ID="regex4" value=""> Found only: <input type="checkbox" id="whitelisted4"><label></label> Hide: <input type="checkbox" id="hidden4"><label></label> Back Color: <input size="7" maxlength="7" type="text" name="color4" class="colorinput" ID="color4" value=""> Color: <input size="7" maxlength="7" type="text" name="fcolor4" class="colorinput" ID="fcolor4" value=""></LI>
				<LI class="regex">Search5: <input type="text" name="regex5" class="regexinput" ID="regex5" value=""> Found only: <input type="checkbox" id="whitelisted5"><label></label> Hide: <input type="checkbox" id="hidden5"><label></label> Back Color: <input size="7" maxlength="7" type="text" name="color5" class="colorinput" ID="color5" value=""> Color: <input size="7" maxlength="7" type="text" name="fcolor5" class="colorinput" ID="fcolor5" value=""></LI>
