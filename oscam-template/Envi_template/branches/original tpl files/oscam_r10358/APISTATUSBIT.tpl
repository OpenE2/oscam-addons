<!--OSCam;463219544;1.20-unstable_svn;10358;-->
      <client type="##CLIENTTYPE##" name="##CLIENTUSER##" desc="##CLIENTDESCRIPTION##" protocol="##CLIENTPROTO##" protocolext="##CLIENTPROTOTITLE##" au="##CLIENTCAU##" thid="##CSIDX##">
