<!--OSCam;1238983921;1.20-unstable_svn;10358;-->
		...
		<TABLE CLASS="config">
			...
			<TR><TD><A>Net prio:</A></TD><TD><input name="netprio" class="short" type="text" maxlength="3" value="##NETPRIO##"></TD></TR>
...
##TPLUNLOCKPARENTAL##
			...
			<TR><TD><A>Usr file:</A></TD>
				<TD>
					<input name="usrfile" type="text" maxlength="128" value="##USERFILE##">&nbsp;
			...
			<TR><TD><A>Mail file:</A></TD>
				<TD>
					<input name="mailfile" type="text" maxlength="128" value="##MAILFILE##">&nbsp;
			...
			<TR><TD><A>Log file / max size:</A></TD>
				<TD>
					<input name="logfile" type="text" maxlength="128" value="##LOGFILE##">&nbsp;
					...
					<input name="maxlogsize" class="withunit short" type="text" maxlength="5" value="##MAXLOGSIZE##"> kB
				</TD>
			</TR>
			...
			<TR><TD><A>Loghistory Size:</A></TD><TD><input name="loghistorysize" class="short" type="text" maxlength="4" value="##LOGHISTORYSIZE##"></TD></TR>
