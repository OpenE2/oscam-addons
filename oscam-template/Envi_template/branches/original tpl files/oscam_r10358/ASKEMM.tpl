<!--OSCam;2851768315;1.20-unstable_svn;10358;-->
##TPLHEADER##
##TPLMENU##
##TPLMESSAGE##
	<DIV ID="subnav">
	...
	<form action="emm_running.html" method="get"><input type="hidden" name="label" value="##READER##">
		...
		<DIV CLASS="extract">
			<P class="emmhead">Saved EMMs for Reader: ##READER##</P>
			<P>UniqueEMM&nbsp;&nbsp;&nbsp;&nbsp;<span class="emminfo">##RDREMMUNIQUE_TXT##</span></P>
			<PRE>##RDREMMUNIQUE##</PRE>
			<P>SharedEMM&nbsp;&nbsp;&nbsp;&nbsp;<span class="emminfo">##RDREMMSHARED_TXT##</span></P>
			<PRE>##RDREMMSHARED##</PRE>
			<P>GlobalEMM&nbsp;&nbsp;&nbsp;&nbsp;<span class="emminfo">##RDREMMGLOBAL_TXT##</span></P>
			<PRE>##RDREMMGLOBAL##</PRE>
		</DIV>
	</form>
##TPLFOOTER##
