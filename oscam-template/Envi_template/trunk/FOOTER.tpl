...
<!-- ========================== SCRIPT FILES ========================== -->
	...
	*  =============================== */
	!function ($) {
		$(function(){
			$('.envi ul.addClass a').tooltip({animation: false, placement: 'top'})
			$('.envi input[type="submit"]').tooltip({animation: false, placement: 'bottom'})
			$('.envi td.centered a').tooltip({animation: false, placement: 'right'})
		})
	}(window.jQuery)
