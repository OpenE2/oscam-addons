<!--OSCam;4260640315;1.20-unstable_svn;9063;-->
				...
				<TR><TD>##TPLHELPPREFIX##server#mhz##TPLHELPSUFFIX##MHz:</A></TD><TD><input name="mhz" type="text" size="5" maxlength="5" value="##MHZ##"> Dreambox Mipsel: 2700, PPC: 3150, DM7025: 8300</TD></TR>
			<TR><TD>##TPLHELPPREFIX##server#autospeed##TPLHELPSUFFIX##Autospeed:</A><input name="autospeed" type="hidden" value="0"></TD><TD><input name="autospeed" type="checkbox" value="1" ##AUTOSPEEDCHECKED##>Sets mhz according to atr. Default is checked. For smartreader and smargo protocol, others will come ass well</TD></TR>
				<TR><TD>##TPLHELPPREFIX##server#cardmhz##TPLHELPSUFFIX##Card MHz:</A></TD><TD><input name="cardmhz" type="text" size="5" maxlength="5" value="##CARDMHZ##"> Dreambox Auto Mode: -1</TD></TR>
